...
export const LoggedInMessage = (props) => {
  return (
    ...
    <h1 className="welcome-heading">Welcome To Shoshin Code</h1>
      ...
      Share {<MaterialIcon icon="share" color={colorPallet.blueGrey._500} />} will copy a link to your clipboard so you can Slack / DM / Email it to a friend, mentor, or interviewer. The link will connect them to your exercise view with a read-only version of your editor, so they can view you coding live. Chat is coming in soon :)</p>
    </div>
  )
}